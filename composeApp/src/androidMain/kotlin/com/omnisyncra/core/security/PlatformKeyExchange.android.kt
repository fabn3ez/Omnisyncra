...
/**
 * Android implementation of key exchange using Android Security APIs
 */
actual class PlatformKeyExchange {
    ...
    actual suspend fun generateX25519KeyPair(): KeyPair {
        // Android doesn't support X25519 in all versions, use ECDH with P-256
    ...
    actual suspend fun hkdfExpand(
        ...
        // HKDF implementation for Android
