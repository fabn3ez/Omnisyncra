...
/**
 * WASM implementation with simplified key exchange operations
 * Note: Full X25519 support in WASM is limited, this provides basic functionality
 */
actual class PlatformKeyExchange {
    ...
    actual suspend fun hkdfExpand(
        ...
        while (offset < outputLength) {
            ...
            // Manual array copy for WASM compatibility
